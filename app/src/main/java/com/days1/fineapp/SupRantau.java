...
public class SupRantau extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        try {
            ...
            if (pilihan.equals("Call Center")){
                String notlp = "Telp: +6262421688";
                a = new Intent (Intent.ACTION_DIAL, Uri.parse(notlp));
            }
            else if (pilihan.equals("SMS Center")){
                String smsText = "M Dafa Malfino/L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("SMS: +6262421688"));
                a.putExtra("sms_body",smsText);
            }
            else if (pilihan.equals("Driving Direction")){
                String lokasirs = "google.navigation:q=2.0934805389727043, 99.83971571534232";
                ...
                a.putExtra(SearchManager.QUERY,"Brastagi Supermarket Rantauprapat");
            }
            startActivity(a);
        } catch (Exception e) {
            e.printStackTrace();
