...
public class Polmedankota extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        try {
            ...
            if (pilihan.equals("Call Center")){
                ...
                String lokasirs = "google.navigation:q=3.5664003548655248, 98.69289492328842";
                ...
                a.putExtra(SearchManager.QUERY,"Polsek Medan Kota");
            }
            startActivity(a);
        } catch (Exception e) {
            e.printStackTrace();
