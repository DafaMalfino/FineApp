...
public class SupMan extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        try {
            ...
            if (pilihan.equals("Call Center")){
                String notlp = "Telp: +626180867942";
                a = new Intent (Intent.ACTION_DIAL, Uri.parse(notlp));
            }
            else if (pilihan.equals("SMS Center")){
                String smsText = "M Dafa Malfino/L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("SMS: +626180867942"));
                a.putExtra("sms_body",smsText);
            }
            else if (pilihan.equals("Driving Direction")){
                String lokasirs = "google.navigation:q=3.5917769746962542, 98.6268828073962";
                ...
                a.putExtra(SearchManager.QUERY,"Brastagi Supermarket Manhattan");
            }
            startActivity(a);
        } catch (Exception e) {
            e.printStackTrace();
